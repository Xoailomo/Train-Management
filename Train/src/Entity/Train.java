...
public class Train implements Serializable {
    ...
    public String toString() {
        return String.format("Train Code: %s |", tcode,
                " Name: %s |", name,
                " Departing station: %s |", dstation,
                " Arriving Station: %s |", astation,
                " Deprating Time: %.2f |", dtime,
                " Arriving Time; %.2f |", atime,
                " Total seats: %d |", seat,
                " seat booked: %d ", booked);
