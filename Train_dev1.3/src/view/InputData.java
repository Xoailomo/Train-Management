...
public class InputData {
    ...
    public static final String TRAIN_URL = "trains.txt";
    public static final String PASSENGER_URL = "passengers.txt";
    public static final String BOOKING_URL = "bookings.txt";
